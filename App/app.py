...
app.layout = html.Div(style={'backgroundColor': colors['background'],'width': 'min(95%, 1200px)','margin': '0 auto'}, children=[
    ...
    html.Div(
        style={'background-image': 'url(assets/generologo.png)', 'background-size': 'cover', 'background-repeat': 'no-repeat', 'background-position': 'center center','textAlign': 'center', 'color': colors['footer'] },
        children=[
                html.H1(
                    style={'textAlign': 'center','font-weight': '700','padding': '5rem', 'margin':'0'},
                    children='Análisis en México con perspectiva de Género'
                )
